...
def enviar_correo():
    ...
    subject = f"Pipeline {os.getenv('JOB_NAME', 'Desconocido')} #{os.getenv('BUILD_NUMBER', 'Desconocido')} Resultado"
    ...
    <p>Revisa los detalles en: <a href="{os.getenv('BUILD_URL')}">{os.getenv('BUILD_URL')}</a></p>
